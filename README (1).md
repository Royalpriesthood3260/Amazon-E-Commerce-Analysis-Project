...
An intermediate SQL project analyzing 1 million e-commerce transactions. The project covers setting up the data, cleaning it, exploring it, and answering 5 business questions with real results and insights.
...
│
├── amazon_ecommerce_project.sql     # Main SQL script
└── README.md
```
